...
public class Q2ALoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(org.qaoverflow.q2android.R.layout.login);

		final Activity activity = this;
		prefs = PreferenceManager.getDefaultSharedPreferences(this);
		
		final EditText website = (EditText) findViewById(org.qaoverflow.q2android.R.id.website);
		final EditText username = (EditText) findViewById(org.qaoverflow.q2android.R.id.username);
		final EditText password = (EditText) findViewById(org.qaoverflow.q2android.R.id.password);
		...
		Button cancel = (Button) findViewById(org.qaoverflow.q2android.R.id.cancel);
		Button login = (Button) findViewById(org.qaoverflow.q2android.R.id.login);
		Button register = (Button) findViewById(org.qaoverflow.q2android.R.id.register);
		...
		login.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				if(website_string.equals("") || username.getText().toString().equals("") || password.getText().toString().equals("")) {
					Toast.makeText(activity, org.qaoverflow.q2android.R.string.missing_value,
