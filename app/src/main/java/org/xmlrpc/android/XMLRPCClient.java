...
import org.qaoverflow.q2android.Q2Android;
...
public class XMLRPCClient {
	...
	public XMLRPCClient(URI uri, String httpuser, String httppasswd) {
		...
		postMethod.addHeader("User-Agent", "bp-android/" + Q2Android.versionName);
	...
	protected String parseResponse(HttpResponse response) {
		...
		Log.i("Q2A", "Response status " + response.getStatusLine().toString());
